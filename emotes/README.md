...
There are 48 [emotes](https://conanexiles.fandom.com/wiki/Emotes); some are duplicated and can be learnt at multiple locations such as the Worship ones.
...
|Celebrate   | Cheer          | `C12` |_Shaman's Rise_                |`TeleportPlayer  -71800  215000 -14700`| Talk to _Nunu the Cannibal_ |
...
Press `Ctrl`-`Shift`-`Alt`-`L` to toggle displaying your location coordinates. If you are not familiar with how the X, Y, Z coordinates work then here is a primer.  Conan Exiles uses Unreal Engine 4 which uses a Left-Handed Coordinate System (LHCS):
  ...
  * +Z is Up (+8600 top of _Fingerfang Rock_, -20000 bottom of a "crater" such as _Skulker's End_)
                 ...
                 |                  |
        West     |  o----> +X       | East
        -9999    |  |               | +9999 (towards Jungle and Ocean)
        Sepermeru|  |               |
                 |  v               |
                 |  +Y              |
                 |                  |
